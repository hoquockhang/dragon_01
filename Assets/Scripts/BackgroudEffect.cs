...
public class BackgroudEffect
{
    ...
    public static Image water3 = GameCanvas.loadImage("/mainImage/11527.png");
    public static Image water4 = GameCanvas.loadImage("/mainImage/11528.png");
    ...
    public void paintWater(mGraphics g)
	{
        ...
        if (mGraphics.zoomLevel != 4)
        {
            ...
            {
                g.drawImage(j % 2 == 0 ? BackgroudEffect.water3 : BackgroudEffect.water4, this.x[j], this.y[j] + this.yWater, 0);
            }
        }
    }
