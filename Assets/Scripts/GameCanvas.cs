...
public class GameCanvas : IActionListener
{
	...
	public void initGame()
	{
		...
		//tạo tài khoản
        CmdLine.btn0left = loadImageX4("/bag/btn0left.png");
        CmdLine.btn0mid = loadImageX4("/bag/btn0mid.png");
        CmdLine.btn0right = loadImageX4("/bag/btn0right.png");
        CmdLine.btn1left = loadImageX4("/bag/btn1left.png");
        CmdLine.btn1mid = loadImageX4("/bag/btn1mid.png");
        CmdLine.btn1right = loadImageX4("/bag/btn1right.png");
    ...
    public static Image loadImageX4(string path)
    {
        ...
        {
            UnityEngine.Debug.Log("Lỗi load Image: " + path);
        }
        return result;
    }
	...
	//{
	//    string fullPath = Main.res + "/inven" + path;

	//    Image result = null;
	//    try
	//    {
	//        result = GameCanvas.loadImage(fullPath);
	//    }
	//    catch (Exception)
	//    {
	//    }
